...
mod tests {
    ...
    use windows::Win32::Graphics::Gdi::{
        ...
        DEFAULT_PITCH, DIB_RGB_COLORS, DT_NOPREFIX, DT_SINGLELINE, DeleteDC, DeleteObject,
        DrawTextW, FONT_OUTPUT_PRECISION, FW_NORMAL, FillRect, GetDC, HGDIOBJ, ReleaseDC,
        SelectObject, SetBkMode, SetTextColor, TRANSPARENT,
    };
    use windows::core::w;

    /// GDIでテキストを白背景に黒文字で描画したBGRA画像を作る(実推論の疎通確認用)
    fn render_text(text: &str, w: i32, h: i32) -> Captured {
        unsafe {
